...
export class AplicationPageComponent implements OnInit {
  ...
  save() {
    ...
    if(addLotsFormData.lot_bank == true) {
      this.checkB = false
    } else if (addLotsFormData.lot_bank == false) {
      this.checkB = true
    }
